...
class ILuaInterface001
{
	public:
		...
		/*0*/virtual int			GetIRef( void ) = 0;
		/*1*/virtual bool		Init( void ) = 0;

		/*2*/virtual void		Shutdown( void ) = 0;
		/*3*/virtual void		Cycle( void ) = 0;
...
class ILuaInterface : public ILuaInterface002
{
	public:
		...
		virtual void ResetMd5() = 0;
		virtual const char* GetMD5String() = 0;
		virtual void MD5Changed() = 0;
		virtual void SetTick(int tick) = 0;
		virtual void MD5Ack(int tick) = 0;
